package org.ratel.cloud.security.aspect;
...
import org.ratel.cloud.core.annotation.security.PreAuth;
import org.ratel.cloud.core.context.ContextConstants;
import org.ratel.cloud.core.exception.ForbiddenException;
...
UriSecurityPreAuthAspect implements ApplicationContextAware {
     ...
     */
    @Around("execution(public * org.ratel.cloud.core.base.controller.*.*(..)) || " +
            "@annotation(org.ratel.cloud.core.annotation.security.PreAuth) || " +
            "@within(org.ratel.cloud.core.annotation.security.PreAuth)"
    )
